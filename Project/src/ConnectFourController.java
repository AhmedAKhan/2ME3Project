    ...
    class Listener implements ActionListener, MouseInputListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (buttonPressedIconString.equals(ConnectFourView.mainPlayButtonImageName)) {
                ...
                model.setGameState(ConnectFourModel.GameState.Game);    // sets the current state to the game
                view.switchScreen(ConnectFourModel.GameState.Game);     // switches the game screen to the game
