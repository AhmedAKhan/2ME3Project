...
public class ConnectFourController {
    ...
    class Listener implements ActionListener, MouseInputListener {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            System.out.println("mousePosition.x: " + mousePosition.x + " mousePosition.y " + mousePosition.y);
            System.out.println("oritin: (" + view.getOriginOfBoard().x + ","+view.getOriginOfBoard().y+")");
